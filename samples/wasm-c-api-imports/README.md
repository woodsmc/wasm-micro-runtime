...
covered by the WASM runtime. Like `env.pthread_`. Plus, [the native lib registration](https://github.com/wasm-micro-rutnime/wasm-micro-runtime/blob/main/doc/export_native_api.md)
