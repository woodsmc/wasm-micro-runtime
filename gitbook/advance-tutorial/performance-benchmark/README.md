...
Well, you don't have to take our word for it. You could run the [Benchmarks in our repo](https://github.com/wasm-micro-rutnime/wasm-micro-runtime/tree/main/tests/benchmarks) and decide whether the performance is good enough.
...
- [Performance and footprint data](https://github.com/wasm-micro-rutnime/wasm-micro-runtime/wiki/Performance): checkout [here](https://github.com/wasm-micro-rutnime/wasm-micro-runtime/wiki/Performance) for the performance and footprint data
